...
public class PraiseTask extends AsyncTask<String, Void, List<String>> {

    private final Context context;
    AlertDialog.Builder dialog;

    public PraiseTask(Context context, AlertDialog.Builder dialog) {
        this.context = context;
        this.dialog = dialog;
    }

    @Override
    protected List<String> doInBackground(String... target) {
        JSONObject jo = ApiUtil.getMyJsonObject(context, "/praise/check?target=" + target[0]);
